...
public class OverlayView extends RelativeLayout {
	...
	private void inflateView() {
		// Inflates the layout resource, sets up the LayoutParams and adds
		// the
	...
	protected void onInflateView() {
		// Override this to make calls to findViewById() to setup references
		// to
		// the views that were inflated.
		// This is called automatically when the object is created right
		// after
		// the resource is inflated.
	}

	public boolean isVisible() {
		// Override this method to control when the Overlay is visible
		// without
		// destroying it.
		return true;
	}
	...
	protected void refreshViews() {
		// Override this method to refresh the views inside of the Overlay.
		// Only
		// called when Overlay is visible.
	}

	protected boolean showNotificationHidden() {
		// Override this to configure the notification to remain even when
		// the
		// overlay is invisible.
		return true;
	}

	protected boolean onVisibilityToChange(final int visibility) {
	...
	protected boolean isInside(final View view, final int x, final int y) {
	...
	protected void onTouchEvent_Up(final MotionEvent event) {
	}

	protected void onTouchEvent_Move(final MotionEvent event) {
	}
